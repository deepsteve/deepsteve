...
The settings modal shows when a new version is available (checks the latest GitHub release). To update, re-run the install one-liner — it overwrites `~/.deepsteve/` and restarts the daemon.
